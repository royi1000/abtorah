...
DATABASES = {
    'default': {
        ...
        'NAME': '/data/db/db.sqlite', # Or path to database file if using sqlite3.
...
CACHES = {
    'default': {
        ...
        'LOCATION': '../django_cache/',  # can be any accessible path, not necessarily a path inside sefaria eg. /home/user/data/django_cache.
    }
}
...
SEFARIA_DATA_PATH = '/data/dir' # used for Data
SEFARIA_EXPORT_PATH = '/data/export' # used for exporting texts
